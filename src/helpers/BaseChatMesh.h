...
protected:
  ...
  virtual int  getBlobByKey(const uint8_t key[], int key_len, uint8_t dest_buf[], size_t dest_len) { return 0; }  // not implemented
...
public:
  ...
  uint8_t exportContact(const ContactInfo& contact, uint8_t dest_buf[], size_t dest_len);
